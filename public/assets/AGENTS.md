...
- Prefer optimized WebP or AVIF for online raster assets. Keep PNG or SVG only when transparency, icon fidelity, source editing, or compatibility requires it.
...
- For large raster assets used online, prefer optimized WebP or AVIF over PNG/JPG.
- When replacing a large PNG or JPG source asset, convert the final app-facing asset to optimized WebP and/or AVIF unless there is a clear reason not to.
