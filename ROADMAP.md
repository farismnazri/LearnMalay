...
Updated: 2026-09-21
Current version baseline: `0.21.0`
...
- Shipped `0.20.0` as a minor release for the private admin analytics dashboard, protected analytics APIs, learner activity tracking, and sortable/filterable admin user directory.
- Shipped `0.21.0` as a minor release for the bilingual Privacy Notice, minimized public leaderboard/API data, account-deletion handling, authenticated retention infrastructure, and the Chapter 1 greetings and pronoun update.
