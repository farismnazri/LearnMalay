...
* Each chat should have a clear everyday situation, such as greeting, asking for help, buying food, meeting family, asking directions, or handling a simple task.
* Chat length and difficulty should follow world progression:

  * World 1 chapters: keep chats at exactly 8 turns total where possible, with a maximum of 8 speech bubbles total. These chats should stay very simple, use short natural lines, and repeat vocabulary from the lesson.
  * World 2 chapters: keep chats at exactly 10 turns total where possible. Use a flat 10-turn target across World 2, but increase sentence difficulty gradually from earlier World 2 chapters to later World 2 chapters.
  * World 3 chapters: keep chats at exactly 10 turns total where possible. Difficulty may increase much more strongly than in World 2, with longer and more connected sentences, as long as the vocabulary, grammar, and cultural context have already been taught or are immediately clarified.
* If a chat must be shorter because of page layout, learner load, or chapter structure, preserve conversational logic first and report why the chat is shorter.
