  ...
  pages: [
    ...
    // Chat: Bank account opening
    {
      ...
      title: {
        ...
        es: "Situación 5.1 Datos personales (actualizar un perfil)",
      },
      context: {
        ms: "Latar tempat: Kaunter bantuan pelanggan di bank.",
        en: "Setting: Customer help counter at the bank.",
        es: "Lugar: Mostrador de ayuda al cliente en el banco.",
      },
      participants: [
        {
          id: "pegawai",
      ...
      messages: [
        ...
        },
        {
          ...
          from: "pegawai",
          text: {
            ms: "Boleh. Sila isi borang ringkas ini.",
            en: "Sure. Please fill in this short form.",
            es: "Claro. Complete este formulario breve, por favor.",
          },
        },
        {
          id: "c5-51-m6",
        ...
        },
        {
          ...
          text: {
            ...
            es: "Bien. Para el idioma, elijo malayo.",
          },
        },
        {
          id: "c5-51-m9",
        ...
        },
        {
          ...
          from: "pegawai",
          text: {
            ms: "Baik. Saya semak borang ini dahulu. Profil encik akan dikemas kini hari ini.",
            en: "Alright. I will check this form first. Your profile will be updated today.",
            es: "Muy bien. Primero revisare este formulario. Su perfil se actualizara hoy.",
          },
        },
        {
          id: "c5-51-m12",
