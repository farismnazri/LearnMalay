...
export const CHAPTER_SUMMARIES: readonly ChapterSummary[] = [
  ...
  { id: 4, revision: 4, title: { ms: "Masa\n& Arah Jalan" } },
  { id: 5, revision: 3, title: { ms: "Nombor, Angka & Alamat" } },
  { id: 6, revision: 2, title: { ms: "Alam Sekitar & Cuaca" } },
  { id: 7, revision: 2, title: { ms: "Makanan & Kuih-muih" } },
  { id: 8, revision: 1, title: { ms: "Perayaan di Malaysia" } },
  { id: 9, revision: 2, title: { ms: "Pekerjaan di Sekitar Kita" } },
